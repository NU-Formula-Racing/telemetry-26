...
static void MX_GPIO_Init(void) {
  ...
  HAL_GPIO_WritePin(GPIOA, SD_STATUS_Pin | LORA_STATUS_Pin | SPI2_CS_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin =
      LORA_DIO0_Pin | LORA_DIO1_Pin | LORA_DIO2_Pin | LORA_DIO3_Pin | LORA_DIO4_Pin | LORA_DIO5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : SD_STATUS_Pin LORA_STATUS_Pin SPI2_CS_Pin */
  GPIO_InitStruct.Pin = SD_STATUS_Pin | LORA_STATUS_Pin | SPI2_CS_Pin;
